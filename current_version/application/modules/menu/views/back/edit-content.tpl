...
<form id="{$seoForm->getId()}" method="POST" action="{routeShort action="edit-content" id=$id}" enctype="multipart/form-data">
	...
	<div class="zone">
		<div class="zone_titre">
			...
			<div>Informations relatives au référencement de cette page</div>
		</div>
	...
	<div class="zone">
		<div class="zone_titre">
			...
			<div>Informations relatives au template et diaporama de cette page</div>
		</div>
