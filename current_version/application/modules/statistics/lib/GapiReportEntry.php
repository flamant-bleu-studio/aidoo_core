...
/**
 * Class Statistics_Lib_GapiReportEntry
 * 
...
class Statistics_Lib_GapiReportEntry
{
  ...
  public function __call($name,$parameters)
  {
    ...
    $metric_key = Statistics_Lib_Gapi::array_key_exists_nc($name,$this->metrics);
    ...
    $dimension_key = Statistics_Lib_Gapi::array_key_exists_nc($name,$this->dimensions);
