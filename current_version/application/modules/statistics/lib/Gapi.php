...
class Statistics_Lib_Gapi
{
   ...
   * @return Array of Statistics_Lib_GapiAccountEntry objects
   */
  protected function accountObjectMapper($xml_string)
  {
    ...
    /*
     * Problème ! $google_result n'existe pas ...
    ...
    */
    ...
    foreach($xml->entry as $entry)
    {
      ...
      $results[] = new Statistics_Lib_GapiAccountEntry($properties);
    }
   ...
   *
   * @param String $xml_string
   * @return Array of Statistics_Lib_GapiReportEntry objects
   */
  protected function reportObjectMapper($xml_string)
  {
    ...
    foreach($xml->entry as $entry)
    {
      ...
      $results[] = new Statistics_Lib_GapiReportEntry($metrics,$dimensions);
    }
