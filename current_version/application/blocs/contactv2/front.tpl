...
<div class="form-{$type_form} {$form->getId()}">
	...
	<span class="success" style="display:none;">Mail envoyé avec succès</span>
		...
		if($(this).validationEngine('validate')){
			...
			$.ajax({
				...
				success: function(results){
					...
					{
						$(".{/literal}{$form->getId()}{literal} span.error").css("display", "none");
						$(".{/literal}{$form->getId()}{literal} span.success").css("display", "inline");
						$(".{/literal}{$form->getId()}{literal} form").slideUp();
					}
				}
			});
