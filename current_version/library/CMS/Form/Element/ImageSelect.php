...
class CMS_Form_Element_ImageSelect extends Zend_Form_Element 
{
    ...
    public function __construct($field_name, $attributes = null) {
		...
		CMS_Application_ProcessLayout::getInstance()->appendJsFile(COMMON_LIB_PATH.'/lib/tiny_mce/plugins/imagemanager/js/mcimagemanager.js');
