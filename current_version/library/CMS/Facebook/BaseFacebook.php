...
abstract class CMS_Facebook_BaseFacebook
{
  /**
   * Version.
   */
   ...
   * @throws CMS_Facebook_FacebookApiException
   */
  ...
  protected function makeRequest($url, $params, $ch=null) {
    ...
    if ($result === false) {
      $e = new CMS_Facebook_FacebookApiException(array(
  ...
  protected function throwAPIException($result) {
    $e = new CMS_Facebook_FacebookApiException($result);
    switch ($e->getType()) {
